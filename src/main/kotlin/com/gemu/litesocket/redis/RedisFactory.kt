package com.gemu.litesocket.redis
...
class RedisFactory(val conf: RedisConfiguration) {
    ...
    companion object Plugin : BaseApplicationPlugin<ApplicationCallPipeline, RedisConfiguration, RedisFactory> {
